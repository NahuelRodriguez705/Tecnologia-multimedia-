...
void draw(){
    ...
    fill(0);
    textSize(20);
    text("Click para iniciar",230,350);
    ...
    if (texto3 < -350){ fondo = 4; }
     
  } else if (fondo == 4){
     image(foto_4,0,0,param1,param2);
    fill(0);
    text("Character Face Models",250,30+texto4);
    text("Leon S. Kennedy",250,60+texto4);
    text("CHRISTIAN DUERRE",300,100+texto4);
    text("Ashley Graham",250,150+texto4);
    text("BROOKE ELIZABETH",300,200+texto4);
    text("Technical suport",250,250+texto4);
    text("NAOKI SAKAMOTO",300,300+texto4);
    
    println(texto4);
    texto4 = texto4 - speedletra;
  
    if (texto4 < -350){ fondo = 0; texto1 = 400; texto2 = 400; texto3 = 400; texto4 = 400; }
  }
    
}

void mousePressed(){
  if(fondo == 0 & mouseX > 230 & mouseX < 380 & mouseY > 325 & mouseY < 365){fondo = 1;
  }
}
